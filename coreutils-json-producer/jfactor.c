 ...
 */
//config:config JFACTOR
//config:	bool "jfactor (2.7 kb)"
//config:	default y
//config:	help
//config:	jfactor factorizes integers

//applet:IF_JFACTOR(APPLET(jfactor, BB_DIR_USR_BIN, BB_SUID_DROP))

//kbuild:lib-$(CONFIG_JFACTOR) += jfactor.o cJSON.o

//usage:#define jfactor_trivial_usage
//usage:       "[NUMBER]..."
//usage:#define jfactor_full_usage "\n\n"
//usage:       "Print prime factors in JSON format"
...
int jfactor_main(int argc UNUSED_PARAM, char **argv)
{
	unpack_wheel();
